...
*/
    ...
    public static Picture hidePicture(Picture p, Picture h, int x, int y)
    {
        ...
        for(int row = y, row2 = 0;  row < picPixels.length && row2 < hiddenPixels.length; row++, row2++){
            for(int col = x, col2 = 0; col < picPixels[0].length && col2 < hiddenPixels[row2].length; col++, col2++){
    ...
    public static Picture showDifferenceArea(ArrayList<Point> list, Picture comPic){
        ...
        for(int i = 0; i < list.size(); i ++){
            ...
            if(list.get(i).getY() == list.get(0).getY() || list.get(i).getY() == list.get(list.size()-1).getY() || list.get(i).getX() == list.get(0).getX() || list.get(i).getX() == list.get(list.size()-1).getX())
...
/*
        ...
        //unhidden.explore(); 
        System.out.println(findDifferences(beach, ).size())
        //Picture hidden3 = showDifferenceArea(findDifferences(hidden1,beach), beach);
       // hidden3.explore();
        //Picture hidden4 = showDifferenceArea(findDifferences(hidden2,beach), hidden3);
       // hidden4.explore();*/
       ...
       {
       Picture hall4 = showDifferenceArea(findDifferences(hall, hall3), hall);
       hall4.show();
